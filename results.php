...
//                    Create if else statements to determine which burger fits best by points
                ...
                if ($allevragen <= 100)
                {
                    echo "De Mc Plant past het beste bij jou<br>" . "Je punten aantal was " . $allevragen . "punten";
                }
                ...
                {
                    echo "De Quarter Pounder past het beste bij jou<br>" . "Je punten aantal was " . $allevragen . "punten";
                }
                else
                {
